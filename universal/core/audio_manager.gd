...
const SFX_BUILD_PLACE: String = "res://assets/audio/game_sfx/build_place.wav"
...
const SFX_RAIDER_BITE: String = "res://assets/audio/game_sfx/raider_bite.wav"
const SFX_RAIDER_DESTROY: String = "res://assets/audio/game_sfx/raider_destroy.wav"
